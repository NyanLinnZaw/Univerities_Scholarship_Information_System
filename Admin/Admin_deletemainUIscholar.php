    ...
    if($row > 0){
        while($row = mysqli_fetch_assoc($result)){
            ...
            if($expiration_date > $today){
                $btn = $row['scholar_id'];
                echo "<form action='Admin_deleteUIscholar.php' method='POST'>";
                echo "<tr style='color: white;'><td>".$counter."</td>
                          ...
                          <td valign='middle'><input type='submit' class='btn btn-primary' name='submit' value='Delete'>
                          <input type='text' name='scholar_id' value = '$btn' hidden></td>
                      <tr>";
                $counter++;
                echo "</form>";
            }
                 ...
                 echo "<tr style='background-color: #fa728d; color: white;'><td>".$counter."</td>
                          ...
                          <td>" .$row['deadline']. "</td>
                          <td valign='middle'>". "<img src=".$row['uni_image'].' class=rounded-circle width=100px height=100px>' ."</td>
                          <td valign='middle'><input type='submit' class='btn btn-primary' name='delete' value='Delete'>
                          <input type='text' name='scholar_id' value = '$btn' hidden></td>
                      <tr>";
                 $counter++;
                 echo "</form>";
