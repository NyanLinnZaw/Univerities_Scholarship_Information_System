...
<div class="top">
   <div class="left">
      <a href="Admin_deletemainUIclass.php"><i class="fa fa-hand-o-left" style="color: white; margin-left: 1200px; font-size: x-large;"></i></a>
      <form action="Admin_deleteclass.php" method="POST">
